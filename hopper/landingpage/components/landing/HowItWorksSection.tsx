            ...
            {activeStep === 2 && (
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  <div className="col-span-2 p-4 border border-gray-200 rounded-md">
                    <h4 className="font-medium text-gray-800 mb-2">Triage Rules Active</h4>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">Archive low relevance</span>
                        <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full text-xs">Active</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">Delete obvious spam</span>
                        <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full text-xs">Active</span>
                      </div>
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-600">Flag high-value emails</span>
                        <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full text-xs">Active</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 border border-gray-200 rounded-md bg-gray-50">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-medium text-gray-800">Archived</h4>
                      <span className="text-sm text-gray-500">Today</span>
                    </div>
                    <div className="flex items-center">
                      <div className="h-10 w-10 rounded-full bg-red-100 flex items-center justify-center mr-2">
                        <span className="text-red-800 font-bold">8</span>
                      </div>
                      <span className="text-sm text-gray-600">Low relevance emails</span>
                    </div>
                  </div>
                  
                  <div className="p-4 border border-gray-200 rounded-md bg-gray-50">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-medium text-gray-800">Flagged</h4>
                      <span className="text-sm text-gray-500">Today</span>
                    </div>
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600">High-value opportunities</span>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                  <div className="p-4 border-b border-gray-200 bg-gray-50">
                    <div className="flex justify-between items-center">
                      <h3 className="font-bold text-gray-800">Your Squire Daily Digest</h3>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex items-center space-x-4 mb-2">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-600">12 processed</span>
                        </div>
                        <div className="flex items-center">
                          <div className="h-3 w-3 rounded-full bg-green-500 mr-1"></div>
                          <span className="text-sm text-gray-600">2 high-value</span>
                        </div>
                        <div className="flex items-center">
                          <div className="h-3 w-3 rounded-full bg-red-500 mr-1"></div>
                          <span className="text-sm text-gray-600">8 archived</span>
                        </div>
                      </div>
                    </div>
                    
                    <div className="mb-4">
                      <h4 className="font-medium text-gray-800 mb-2">High-Value Opportunities</h4>
                      {[1, 2].map((_, i) => (
                        <div key={i} className="flex items-center p-2 border border-green-100 bg-green-50 rounded-md mb-2">
                          <div className="w-8 h-8 bg-gray-200 rounded-full mr-3"></div>
                          <div className="flex-1">
                            <div className="h-4 w-2/3 bg-gray-200 rounded mb-1"></div>
                            <div className="h-3 w-1/2 bg-gray-100 rounded"></div>
                          </div>
                          <div className="ml-4 text-xs bg-green-200 text-green-800 py-1 px-2 rounded-full">
                            95% match
                          </div>
                        </div>
                      ))}
            ...
            {activeStep === 4 && (
              ...
              >
                <div className="bg-white rounded-md border border-gray-200 overflow-hidden">
                  <div className="flex">
                    {/* Sidebar */}
                    <div className="w-1/4 bg-gray-50 p-3 border-r border-gray-200">
                      <div className="space-y-3">
                        <div className="p-2 bg-blue-100 rounded-md text-blue-800 text-sm font-medium">Dashboard</div>
                        <div className="p-2 text-gray-600 text-sm">Settings</div>
                        <div className="p-2 text-gray-600 text-sm">Rules</div>
                        <div className="p-2 text-gray-600 text-sm">History</div>
                      </div>
                    </div>
                    
                    {/* Main content */}
                    <div className="w-3/4 p-4">
                      <h3 className="font-bold text-gray-800 mb-4">Dashboard Overview</h3>
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <div className="p-3 bg-green-50 border border-green-100 rounded-md">
                          ...
                          <p className="text-xl font-bold text-green-800">42 min</p>
                        </div>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <div className="space-y-2">
                          {[1, 2, 3].map((_, i) => (
                            <div key={i} className="text-xs p-1.5 border-l-2 border-blue-500 bg-gray-50">
                              <div className="flex justify-between">
                                <span className="font-medium">Email classified</span>
                                <span className="text-gray-500">10m ago</span>
                              </div>
                              <p className="text-gray-600 mt-0.5">Vendor outreach from Company {i+1}</p>
                            </div>
                          ))}
                        </div>
                      </div>
